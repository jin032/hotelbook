...
<html dir="ltr" lang="en-US">
    ...
    <body class="no_js responsive boxed-layout chrome ">
                ...
                <div class="group inner">
                    ...
                    <div id="nav" class="group">
                        <ul id="menu-main-nav" class="level-1">
                            ...
                            <li>
                                <a href="contact.php"><i class="icon-list-alt"></i>Contects</a>
                            </li>
        ...
        $get_hotel = "select * from hotel where h_title like '%$user_query%'";
        ...
        ?>
                    <?php
                        ...
                        $get_hotel_city = "select * from hotel where c_id='$city_id' LIMIT $page_1,8";
